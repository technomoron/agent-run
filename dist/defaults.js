...
exports.defaultClaudeSettingsContent = defaultClaudeSettingsContent;
exports.defaultGeminiSettingsContent = defaultGeminiSettingsContent;
exports.defaultGrokConfigContent = defaultGrokConfigContent;
exports.legacyDefaultClaudeSettingsContent = legacyDefaultClaudeSettingsContent;
...
function defaultGeminiSettingsTemplate() {
    return [
        '{',
        '  "general": {',
...
function defaultGrokConfigTemplate() {
...
function defaultGeminiSettingsContent(_context) {
    return `${JSON.stringify({ general: { enableAutoUpdate: true } }, null, 2)}\n`;
}
function defaultGrokConfigContent() {
